...
use App\Http\Requests\Location\CreateContinentRequest;
use App\Http\Requests\Location\UpdateContinentRequest;
...
class ContinentController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('location.continents.index')
    ...
    {
        return view('location.continents.create');
    }
    ...
    public function store(CreateContinentRequest $request)
    {
        ...
        return redirect(route('location.continents.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('location.continents.show')->with('continent', $continent);
    }
    ...
    public function edit($id)
    {
        ...
        return view('location.continents.edit')->with('continent', $continent);
    }
